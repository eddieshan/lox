...
std::array<uint8_t, 10> term::ansi::go_to(const ScreenPosition& screen_pos) {
    auto pos = utils::array::array_of<uint8_t>((uint8_t)27, (uint8_t)91, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)59, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)72); // x1b[row:colH
